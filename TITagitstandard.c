...
// {0xC5,0xCC,0x7A,0x62,0xCB,0x03,0x2C,0xFE,0xE1,0x74,0xBD,0x18,0x2D,0x64,0xC7,0x57,0xCD,0x11,0x7D,0x59,0xDB,0x9D,0x6A,0x5C,0x55,0x4A,0x86,0x1F,0x21,0x1A,0x12,0xF2,0x5B,0x52,0x4A,0x55,0x9C,0xC0,0x07,0xE0,0x00,0x00,0x00,0x00};

//ISO15693UidType Uid = {0x05, 0x5E, 0xD6, 0x56, 0xB2, 0xC0, 0x07, 0xE0};
//0xE0 = iso15693
            ...
            case STATE_READY:
			  ...
			  PageAddress = FrameBuf[2];
                      ...
                      if (FrameBuf[0] & ISO15693_REQ_FLAG_OPTION)
                          {
                              FrameBuf[0] = 0x00; /* Flags */	                      
                              FrameBuf[1] = ( PageAddress == 8 || PageAddress == 9) ? 0x02 : 0x00; /* security dummy to 0 */	                      
			      FramePtr = FrameBuf + 2;				      
                              ResponseByteCount = 6;
